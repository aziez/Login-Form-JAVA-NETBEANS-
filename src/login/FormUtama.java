...
public class FormUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JMExit.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        JMExit.setText("Exit");
    ...
    private void JMExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMExitActionPerformed
        ...
        int dialogResult =  JOptionPane.showConfirmDialog(this, "Anda Yakin  Ingin Keluar..?", "EXIT", dialog);
        if(dialogResult == 0){
            System.exit(0);
        }else{
